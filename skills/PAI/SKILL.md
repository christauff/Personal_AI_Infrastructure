<!--
  ...
  Built:  21 February 2026 00:44:17
-->
---
name: PAI
...
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"algorithm","message": "Entering the PAI Algorithm Observe phase"}'`
...
[VERBATIM - Execute exactly as written, do not modify (Background agents ignore)]
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"algorithm","message": "Entering the Think phase"}'`
...
[VERBATIM - Execute exactly as written, do not modify(Background agents ignore)]
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"algorithm","message": "Entering the Plan phase"}'`
...
[VERBATIM - Execute exactly as written, do not modify(Background agents ignore)]
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"algorithm","message": "Entering the Build phase"}'`
...
[VERBATIM - Execute exactly as written, do not modify(Background agents ignore)]
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"algorithm","message": "Entering the Execute phase"}'`
...
[VERBATIM - Execute exactly as written, do not modify(Background agents ignore)]
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"algorithm","message": "Entering the Verify phase."}'`
...
[VERBATIM - Execute exactly as written, do not modify(Background agents ignore)]
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"algorithm","message": "Entering the Learn phase"}'`
...
🗣️ Aineko: [Spoken summary between 12-24 words.]
```
...
- `daidentity.name` - DA's name (Aineko)
- `principal.name` - User's name (Christauff)
