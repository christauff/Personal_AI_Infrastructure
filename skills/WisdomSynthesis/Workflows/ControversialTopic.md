...
|------------|---------|--------|
| **File path** | `~/Docs/debate.txt` | Read file → Skip Research → Council |
| **URL** | Article/debate URL | Research URL |
| **Topic** | `remote work vs office` | Research topic |

**⚠️ RESOURCE WARNING - VERY HIGH:**
- File mode: **No agent spawning**, direct analysis
- URL/Topic mode: **12 PARALLEL RESEARCH AGENTS** (Extensive mode)
- Estimated time: 60-90 seconds

---

### Step 0a: Verify Controversial Nature

**Important:** Verify topic is genuinely controversial/nuanced. If not, recommend simpler analysis.

---

### Step 0b: File Mode (Skip Research)
...
**Proceed directly to Step 2 (Council) with file content.**

---

### Step 1: Extensive Research Phase (Topic/URL Mode)

**IF INPUT IS TOPIC OR URL:**

⚠️ **CRITICAL RESOURCE WARNING:** Spawns **12 parallel agents**
