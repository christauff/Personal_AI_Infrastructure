...
|------------|---------|--------|
| **File path** | `~/Docs/textbook.pdf` | Read file → Skip Research → Extract |
| **URL** | Educational resource URL | Research URL |
| **Topic** | `quantum mechanics` | Research topic |

**⚠️ RESOURCE WARNING - VERY HIGH:**
- File mode: **No agent spawning**, direct extraction
- URL/Topic mode: **12 PARALLEL RESEARCH AGENTS** (Extensive mode)
- **DANGEROUS for large topics** - can consume significant resources
- Estimated time: 60-90 seconds
- Consider Standard Research (4 agents) for lighter workload
...
echo "📄 File Mode: Skipping Extensive Research (would spawn 12 agents)"
echo "Extracting directly from file content instead."
```
...
### Step 1b: Extensive Research Phase (Topic/URL Mode)

**IF INPUT IS TOPIC OR URL:**

⚠️ **CRITICAL RESOURCE WARNING:** Spawns **12 parallel agents** (4 types × 3 threads)
