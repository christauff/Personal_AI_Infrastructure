...
async function readExistingConfig(): Promise<ExistingConfig> {
  ...
  try {
    const skillPath = `${claudeDir}/skills/PAI/SKILL.md`;
...
╚═══════════════════════════════════════════════════════════════════╝
  ...
  try {
    ...
    await $`mkdir -p ${claudeDir}/skills/PAI/workflows`;
    await $`mkdir -p ${claudeDir}/skills/PAI/tools`;
    ...
    await Bun.write(`${claudeDir}/skills/PAI/SKILL.md`, skillMd);

    console.log("Generating Contacts.md...");
    const contactsMd = generateContactsMd(config);
    await Bun.write(`${claudeDir}/skills/PAI/Contacts.md`, contactsMd);

    console.log("Generating CoreStack.md...");
    const coreStackMd = generateCoreStackMd(config);
    await Bun.write(`${claudeDir}/skills/PAI/CoreStack.md`, coreStackMd);
...
Files updated:
  ...
  - ~/.claude/skills/PAI/Contacts.md
  - ~/.claude/skills/PAI/CoreStack.md
  - ~/.claude/.env
